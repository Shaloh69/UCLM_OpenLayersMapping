  ...
  return (
    <section className="pl-40">
      ...
      <h2 className="pt-50 flex flex-col font-sans">
        <div className="text-[35px] font-bold">FIND YOUR WAY, THE UCLMWAY</div>
      ...
      <h3 className="pt-10 font-jomhuria font-bold text-[30px] ">
        <button
          ...
          className="relative px-6 py-3 rounded-lg border-2 border-white text-white font-bold flex items-center gap-3 overflow-hidden group transition-all duration-500 hover:shadow-[0px_0px_30px_7px_rgba(255,255,255,0.8)]"
        >
